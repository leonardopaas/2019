	...
	<div class="ui inverted vertical masthead aligned segment">
		...
		<section class="lado"></section>
			<ul class="menu">
    			...
    			<li class="hm"><a href="cadReceita.php">Cadastro Receita</a></li>
    			<li class="hm"><a href="">Perfil</a></li>
    			<li class="hm"><a ></a></li>
    			<li class="hm"><a ></a></li>
    			<li class="hm"><a ></a></li>
    			<li class="hm"><a ></a></li>
    			<li class="hm"><a href="login.php">Login</a></li> |
    			<li class="hm"><a href="cadastro.php">Cadastro</a></li>
			</ul>
		<section class="lado"></section>
	</section>
